      ...
      <section className="region-container" id="regions">
        ...
        >
          ...
          <div className="carousel-inner">
            ...
            >
              <img
                src="https://www.hotelcasacarolina.com/wp-content/uploads/2015/05/Tyrona.jpg"
            ...
            >
              <img
                src="https://img.lalr.co/cms/2018/11/23211225/Palomino-Colombia.jpg?size=xl&ratio=r40_21"
            ...
            >
              <img
                src="https://media.tacdn.com/media/attractions-splice-spp-674x446/06/ef/71/53.jpg"
                className="d-block w-100"
                alt="..."
              />
              <div className="carousel-caption d-none d-md-block">
